...
interface EditorBioInterface {
  isEditing: boolean;
  bio: string;
  onChange?: (newBio: string) => void;
}

const EditorBio = ({ bio, onChange }: EditorBioInterface) => {
          ...
          {openLink ? (
            ...
            <>
              ...
              <Button
                ...
                className={`flex h-8 w-8 items-center justify-center hover:bg-stone-700 p-2 text-base cursor-pointer rounded-md text-white bg-stone-950 ${
                  editor.isActive({ textAlign: "center" }) ? "bg-stone-700" : ""
                } `}
                type="button"
              >
              ...
              <Button
                ...
                className={`flex h-8 w-8 items-center justify-center hover:bg-stone-700 p-2 text-base cursor-pointer rounded-md text-white bg-stone-950 ${
                  editor.isActive({ textAlign: "right" }) ? "bg-stone-700" : ""
                } `}
                type="button"
              >
